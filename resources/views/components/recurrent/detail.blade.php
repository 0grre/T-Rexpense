...
@foreach($recurrents as $recurrent)
    ...
    <div class="modal modal-bottom sm:modal-middle">
        <div class="modal-box">
            <h3 class="font-bold text-lg mb-8">{{ __('content.recurrent-transaction.update') }}</h3>
            ...
            <form method="POST" action="{{ 'recurrents/'. $recurrent->id }}">
                ...
                <div class="modal-action">
                    <!-- Open delete modal -->
                    <label for="delete-recurrent-modal-{{$recurrent->id}}" class="btn btn-outline btn-error btn-sm">{{ __('form.delete') }}</label>
            ...
            <div class="modal modal-bottom sm:modal-middle">
                <div class="modal-box">
                    <form method="POST" action="{{ 'recurrents/'. $recurrent->id }}">
                        @method('delete')
                        @csrf
                        <h3 class="font-bold text-lg">{{ __('content.recurrent-transaction.delete') }}</h3>
